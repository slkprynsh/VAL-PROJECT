          ...
          return (
            <Reveal key={stat.label} delay={idx * 0.1}>
              <motion.div
                ...
                className="h-full bg-white rounded-2xl p-8 text-center border border-gray-100 shadow-sm hover:shadow-md hover:border-[#D1F2F7] transition-all duration-300 group"
              >
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-[#E6F7FA] mb-5 group-hover:scale-110 transition-transform duration-300">
